...
gv_vAlignTable['u3'] = 'center';gv_vAlignTable['u21'] = 'center';document.getElementById('u16_img').tabIndex = 0;
...
gv_vAlignTable['u15'] = 'center';document.getElementById('u0_img').tabIndex = 0;
...
gv_vAlignTable['u17'] = 'center';gv_vAlignTable['u5'] = 'center';gv_vAlignTable['u1'] = 'center';gv_vAlignTable['u9'] = 'center';document.getElementById('u6_img').tabIndex = 0;
...
if (true) {
	...
	self.location.href=$axure.globalVariableProvider.getLinkUrl('wiki_entry.html');
